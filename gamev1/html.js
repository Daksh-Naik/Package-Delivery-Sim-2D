class HTMLPSCHARS {
    ...
    startDisplay() {
        ...
        this.control1.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.control2.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.control3.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.control4.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.control5.style('background-color', 'rgba(0, 0, 0, 0.700)');
    ...
    startTut() {
        ...
        this.tutoria1.style('background-color', 'rgba(255, 255, 255, 0.700)');
        ...
        this.tutoria5.style('background-color', 'rgba(255, 255, 255, 0.700)');
        ...
        this.tutoria2.style('background-color', 'rgba(255, 255, 255, 0.700)');
    ...
    startTutd() {
        ...
        this.tutoria3.style('background-color', 'rgba(255, 255, 255, 0.700)');
        ...
        this.tutoria6.style('background-color', 'rgba(255, 255, 255, 0.700)');
    ...
    startDelTut() {
        ...
        this.tutoria7.style('background-color', 'rgba(255, 255, 255, 0.700)');
        this.tutoria7.style('user-select', 'none');
    }

    Status() {
        this.status.position(900, 75);
    ...
    dashDisplay() {
        ...
        this.framecounter.style('background-color', 'rgba(0, 0, 0, 0.700)');
        this.framecounter.style('padding', '10px');
        this.framecounter.style('border-radius', '5px')

        this.odometer.position(1030, 430);
        ...
        this.oppodtimert.position(1070, 490);
        ...
        this.mtimereas.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.nexthouse.style('background-color', 'rgba(0, 0, 0, 0.800)');
    ...
    timeTakenShow() {
        ...
        this.timetaken.style('background-color', 'rgba(0, 0, 0, 0.700)');
    ...
    mHouse1DashDisplay() {
        this.mHouse1delivinst.position(880, 130);
    ...
    mHouse1DashDisplayDeliv() {
        ...
        this.mHouse1delivinstDeli.position(880, 130);
    ...
    mHouse2DashDisplay() {
        this.mHouse2delivinst.position(880, 170);
    ...
    mHouse2DashDisplayDeliv() {
        ...
        this.mHouse2delivinstDeli.position(880, 170);
    ...
    mHouse3DashDisplay() {
        this.mHouse3delivinst.position(880, 250);
    ...
    mHouse3DashDisplayDeliv() {
        ...
        this.mHouse3delivinstDeli.position(880, 250);
    ...
    mHouse4DashDisplay() {
        this.mHouse4delivinst.position(880, 210);
    ...
    mHouse4DashDisplayDeliv() {
        ...
        this.mHouse4delivinstDeli.position(880, 210);
    ...
    mHouse5DashDisplay() {
        this.mHouse5delivinst.position(880, 290);
    ...
    mHouse5DashDisplayDeliv() {
        ...
        this.mHouse5delivinstDeli.position(880, 290);
    ...
    dashDisplayForEnd() {
        ...
        this.odometer.position('970', '430');

        this.DTtimert.position(1000, 460);
        this.DTtimert.html("Total time in sec Driven : " +Math.round(DTtimer));
        this.oppodtimert.position(980, 480);
