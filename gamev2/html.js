class HTMLPSCHARS {
    ...
    constructor() {
        ...
        this.control8 = createElement('h3');
        this.control9 = createElement('h3');
    ...
    startDisplay() {
        ...
        this.ensure.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.ensure2.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.f11.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.control1.style('color', 'white');
        this.control1.style('background-color', 'black');
        ...
        this.control2.style('color', 'white');
        this.control2.style('background-color', 'black');
        ...
        this.control3.style('color', 'white');
        this.control3.style('background-color', 'black');
        ...
        this.control6.style('color', 'white');
        this.control6.style('background-color', 'black');
        ...
        this.control7.style('color', 'white');
        this.control7.style('background-color', 'black');
        this.control7.style('padding', '10px');
        this.control7.style('user-select', 'none');

        this.control8.position(900, 490);
        this.control8.html("Press A to increase CC speed, S to decrease.");
        this.control8.style('color', 'white');
        this.control8.style('background-color', 'black');
        this.control8.style('padding', '10px');
        this.control8.style('user-select', 'none');

        this.control4.position(900, 555);
        this.control4.html("Press P to Pause.");
        this.control4.style('color', 'white');
        this.control4.style('background-color', 'black');
        this.control4.style('padding', '10px');
        this.control4.style('user-select', 'none');

        this.control5.position(1100, 555);
        this.control5.html("Press F5 or E to Restart.");
        this.control5.style('color', 'white');
        this.control5.style('background-color', 'black');
    ...
    tutoriaSt() {
        ...
        this.usearrk.style('background-color', 'rgba(255, 255, 255, 0.700)');
        ...
        this.getonde.style('background-color', 'rgba(255, 255, 255, 0.700)');
        ...
        this.das.style('background-color', 'rgba(255, 255, 255, 0.700)');
    ...
    ccat() {
        ...
        this.cc.style('background-color', 'rgba(0, 0, 0, 0.800)');
        this.cc.style('text-shadow', '10px', '10px', 'black');
        this.cc.style('padding', '10px');
        this.cc.style('border-radius', '10px');
        this.cc.style('transition', '0.3s')

        this.ccinst.position(10, 140);
        ...
        this.ccinst.style('background-color', 'rgba(0, 0, 0, 0.700)');
    ...
    SensorAlr() {
        this.ccsens.style('z-index', '-5');
        this.ccsens.position(10, 285);
        this.ccsens.style('color', 'orange');
        this.ccsens.style('user-select', 'none');
        this.ccsens.style('background-color', 'rgba(0, 0, 0, 0.800)');
        this.ccsens.style('padding', '10px');
        this.ccsens.style('border-radius', '5px');
    }
    ...
    dashDisplay() {
        ...
        this.framecounter.style('background-color', 'rgba(0, 0, 0, 0.850)');
        ...
        this.nexthouse.style('background-color', 'rgba(0, 0, 0, 0.700)');
        ...
        this.nexthousen.style('background-color', 'rgba(0, 0, 0, 0.800)');
        ...
        this.cctimer.style('background-color', 'rgba(0, 0, 0, 0.800)');
        ...
        this.ccspe.style('background-color', 'rgba(0, 0, 0, 0.800)');
    ...
    warning() {
        ...
        this.caution.style('background-color', 'rgba(0, 0, 0, 0.700)');
    ...
    timeTakenShow() {
        ...
        this.timetakeninst.style('background-color', 'rgba(0, 0, 0, 0.700)');
    ...
    gamePause() {
        ...
        this.pause.style('background-color', 'rgba(0, 0, 0, 0.800)');
    ...
    DropPackageInstructShow() {
        ...
        this.dropackinst.style('background-color', 'rgba(0, 0, 0, 0.700)');
    ...
    DropPackageInstructFirstShow() {
        ...
        this.dropackinstfirst.style('background-color', 'rgba(0, 0, 0, 0.700)');
